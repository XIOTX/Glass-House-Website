        ...
        <section className="py-20">
          <div className="container mx-auto px-5">
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg mb-6">
                <strong>Still have questions? We get it.</strong> This might be a big decision. <Link href="/contact" className="underline hover:no-underline">Contact us</Link> to talk to the team, or check out our <Link href="/about" className="underline hover:no-underline">About</Link> and <Link href="/programs" className="underline hover:no-underline">Programs</Link> pages.
              </p>
